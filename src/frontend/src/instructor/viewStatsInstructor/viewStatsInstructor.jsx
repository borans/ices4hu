...
function ViewStatsInstructor(props){
    ...
    const requestReeval = () => {
      fetch("/api/reevaluation_request/instructor?survey="+ surveyID+
      ...
      .then((result) => {
        ...
        .catch((err) => {
          ...
          alert("COULD NOT SEND REEVALUATION REQUEST")
        });
...
export default ViewStatsInstructor;
